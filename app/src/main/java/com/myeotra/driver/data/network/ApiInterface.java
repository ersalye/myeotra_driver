package com.myeotra.driver.data.network;
...
public interface ApiInterface {
    ...
    Observable<User> register(@PartMap Map<String, RequestBody> params, @Part MultipartBody.Part file);
    /*@Multipart
    @POST("api/provider/register")
    ...
    @FormUrlEncoded
    @POST("api/provider/profile/vehical/add")
    Observable<VehicleAddResponse> addVehicle(@FieldMap HashMap<String, Object> params);
...
//    Observable<Object> sendFcm(@Body JsonObject jsonObject);
    ...
    @GET("api/provider/rate-comment")
    Observable<RateCommentResponse> getComment();
}
