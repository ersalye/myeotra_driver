...
import com.myeotra.driver.common.RecyclerItemClickListener;
...
import com.myeotra.driver.ui.adapter.PlacesAutoCompleteAdapter;
...
//                else if (!mGoogleApiClient.isConnected()) Log.e("ERROR", "API_NOT_CONNECTED");
        ...
        rvLocation.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
...
//        }
    ...
    @OnClick({R.id.ivResetDest, R.id.qr_scan, R.id.menu, R.id.txtDone})
