...
import static com.myeotra.driver.MvpApplication.isBraintree;
import static com.myeotra.driver.MvpApplication.isCard;
import static com.myeotra.driver.MvpApplication.isCash;
import static com.myeotra.driver.MvpApplication.isPaytm;
import static com.myeotra.driver.MvpApplication.isPayumoney;
import static com.myeotra.driver.common.Constants.SharedPref.STRIPE_PUBLISHABLE_KEY;
...
public class PaymentActivity extends BaseActivity implements PaymentIView {
    ...
    @BindView(R.id.paytm)
    TextView paytm;
    @BindView(R.id.textCardPayment)
    TextView textCardPayment;
    ...
    public void onResume() {
        ...
        new Handler().postDelayed(() -> {
            ...
            if (isCash && !isInvoiceCashToCard)
                ...
                llCashContainer.setVisibility(View.GONE);
        }, 3000);
    }
    ...
    @OnClick({R.id.cash, R.id.braintree, R.id.paytm, R.id.payumoney, R.id.textCardPayment})
    ...
    public void onSuccess(List<Card> cards) {
        Log.e(TAG, "onSuccess: paymentactvity" + new Gson().toJson(cards));
        try {
            hideLoading();
        } catch (Exception e1) {
            e1.printStackTrace();
        ...
        if (cardsList != null && cardsList.size() > 0) {
            ...
            textCardPayment.setVisibility(View.GONE);
        } else {
            textCardPayment.setVisibility(View.VISIBLE);
        }
    }

    @Override
    public void onError(Throwable e) {
        Log.e(TAG, "onError: PaymentActivity : " + e.getMessage());
        onErrorBase(e);
    }

    @Override
    public void onAddCardSuccess(Object cards) {
        Log.e(TAG, "onAddCardSuccess: " + new Gson().toJson(cards));
        Toast.makeText(this, "data : " + cards.toString(), Toast.LENGTH_SHORT).show();
    }
...
//            getCardsDetails();
            ...
            Log.e(TAG, "pymntactvty : OnActivityResult : " + data.getStringExtra("stripetoken"));
