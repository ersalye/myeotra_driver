...
import com.myeotra.driver.ui.activity.past_detail.PastTripDetailActivity;
import com.myeotra.driver.ui.adapter.PastTripAdapter;
...
public class PastTripFragment extends BaseFragment implements PastTripIView, PastTripAdapter.ClickListener {
    ...
    public void onSuccess(List<HistoryList> historyList) {
        ...
        Log.e(TAG, "getHistory res : " + new Gson().toJson(historyList));
