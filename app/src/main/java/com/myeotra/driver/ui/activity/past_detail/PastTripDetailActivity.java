...
import com.myeotra.driver.data.network.model.User_Past;
import com.myeotra.driver.ui.bottomsheetdialog.invoice_show.InvoiceShowDialogFragment;
import com.myeotra.driver.ui.fragment.dispute.DisputeCallBack;
import com.myeotra.driver.ui.fragment.dispute.DisputeFragment;
import com.myeotra.driver.ui.fragment.dispute_status.DisputeStatusFragment;
...
import static com.myeotra.driver.MvpApplication.DATUM_history;
import static com.myeotra.driver.MvpApplication.DATUM_history_detail;
...
public class PastTripDetailActivity extends BaseActivity implements PastTripDetailIView, DisputeCallBack {
    ...
    private String TAG = "PastTripDetailActivity";
...
//        getSupportActionBar().setTitle(getString(R.string.past_trip_detail));
    ...
    @OnClick({R.id.view_receipt, R.id.menu})
    ...
    public void onSuccess(HistoryDetail historyDetail) {
        ...
        System.out.println("detail--" + historyDetail);
        Log.e(TAG, "onSuccess: " + new Gson().toJson(historyDetail));
