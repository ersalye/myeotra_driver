...
import com.myeotra.driver.ui.activity.welcome.WelcomeActivity;
...
public class SplashActivity extends BaseActivity implements SplashIView {
    ...
    private void redirectToScreen() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                if (SharedHelper.getKey(SplashActivity.this, Constants.SharedPref.LOGGGED_IN).equalsIgnoreCase("true"))
